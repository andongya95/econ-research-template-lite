---
name: research-team
description: Run the multi-coauthor research team — PI + econometrician + paper-writer + theorist in parallel rounds.
user_invocable: true
args: "[resume | round N | status] [--max-rounds N] [--max-budget-usd N]"
